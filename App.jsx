...
/* ---------------------------------------------------------------------
   В среде артефактов Claude доступен window.storage (облачное хранилище).
   В самостоятельном приложении используем обычный localStorage браузера
   с тем же интерфейсом, чтобы остальной код не менять.
--------------------------------------------------------------------- */
